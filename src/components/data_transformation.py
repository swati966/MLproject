...
# Make sure logger is configured first
import src.logger
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """Create transformation pipelines for numerical and categorical columns."""
        try:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """Read train/test CSVs, transform features, and save preprocessing object."""
        try:
...
if __name__ == "__main__":
    ...
    logging.info("Starting data ingestion and transformation pipeline.")
